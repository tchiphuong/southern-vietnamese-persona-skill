...
| Nền Tảng AI / Agent | Tệp Cấu Hình Sinh Ra | Lệnh Cài Đặt 1-Dòng | Tài Liệu Hướng Dẫn Gốc |
| :--- | :--- | :--- | :--- |
| ![Gemini](https://img.shields.io/badge/Google_Gemini-8E75B2?style=flat-square&logo=googlegemini&logoColor=white) **Google Gemini / Antigravity** | `~/.gemini/config/skills/southern-vietnamese-persona/` | `npx southern-vietnamese-persona-skill antigravity` | [Doc Cấu Trúc Prompt ↗](https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/prompt-structure) |
| ![Claude](https://img.shields.io/badge/Claude_Anthropic-D97757?style=flat-square&logo=anthropic&logoColor=white) **Claude Code & Desktop** | `CLAUDE.md` | `npx southern-vietnamese-persona-skill claude` | [Doc Claude Code ↗](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/overview) |
| ![OpenAI](https://img.shields.io/badge/OpenAI_Codex-412991?style=flat-square&logo=openai&logoColor=white) **OpenAI Codex / ChatGPT** | `.codexrules` | `npx southern-vietnamese-persona-skill codex` | [Doc Prompt Engineering ↗](https://platform.openai.com/docs/guides/prompt-engineering) |
| ![Cursor](https://img.shields.io/badge/Cursor_IDE-000000?style=flat-square&logo=cursor&logoColor=white) **Cursor IDE** | `.cursorrules` & `.cursor/rules/*.mdc` | `npx southern-vietnamese-persona-skill cursor` | [Doc Rules for AI ↗](https://docs.cursor.com/context/rules-for-ai) |
| ![Windsurf](https://img.shields.io/badge/Windsurf_IDE-0052CC?style=flat-square&logo=codeium&logoColor=white) **Windsurf IDE** | `.windsurfrules` | `npx southern-vietnamese-persona-skill windsurf` | [Doc Memories & Rules ↗](https://docs.codeium.com/windsurf/memories) |
| ![Continue](https://img.shields.io/badge/Continue.dev-FF5722?style=flat-square&logo=continue&logoColor=white) **Continue.dev** | `~/.continue/prompts/*.prompt` | `npx southern-vietnamese-persona-skill continue` | [Doc Custom Prompts ↗](https://docs.continue.dev/customization/prompts) |
| ![Roo Code](https://img.shields.io/badge/Roo_Code-1890FF?style=flat-square&logo=visualstudiocode&logoColor=white) **Roo Code / Cline** | `.clinerules` & `.roorules` | `npx southern-vietnamese-persona-skill roo` | [Doc Custom Rules ↗](https://github.com/RooVetGit/Roo-Code) |
| ![Aider](https://img.shields.io/badge/Aider_CLI-22C55E?style=flat-square&logo=terminal&logoColor=white) **Aider AI CLI** | `CONVENTIONS.md` | `npx southern-vietnamese-persona-skill aider` | [Doc Conventions ↗](https://aider.chat/docs/usage/conventions.html) |
| ![Blackbox](https://img.shields.io/badge/Blackbox_AI-000000?style=flat-square&logo=github&logoColor=white) **Blackbox AI** | `.blackboxrules` | `npx southern-vietnamese-persona-skill blackbox` | [Doc Blackbox Rules ↗](https://docs.blackbox.ai/) |
| ![Copilot](https://img.shields.io/badge/GitHub_Copilot-000000?style=flat-square&logo=githubcopilot&logoColor=white) **GitHub Copilot** | `.github/copilot-instructions.md` | `npx southern-vietnamese-persona-skill copilot` | [Doc Copilot Instructions ↗](https://docs.github.com/en/copilot/customizing-copilot/adding-custom-instructions-for-github-copilot) |
| ![Amazon Q](https://img.shields.io/badge/Amazon_Q-FF9900?style=flat-square&logo=amazonaws&logoColor=white) **Amazon Q Developer** | `.amazonq/rules.md` | `npx southern-vietnamese-persona-skill amazonq` | [Doc Amazon Q Rules ↗](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/custom-instructions.html) |
| ![Augment](https://img.shields.io/badge/Augment_Code-000000?style=flat-square&logo=codeforces&logoColor=white) **Augment Code** | `.augment/instructions.md` | `npx southern-vietnamese-persona-skill augment` | [Doc Augment Rules ↗](https://docs.augmentcode.com/) |
| ![Trae](https://img.shields.io/badge/Trae_IDE-0052CC?style=flat-square&logo=visualstudiocode&logoColor=white) **Trae IDE / Kilo Code** | `.traerules` | `npx southern-vietnamese-persona-skill trae` | [Doc Trae Rules ↗](https://docs.trae.ai/) |
| ![Replit](https://img.shields.io/badge/Replit_AI-F26207?style=flat-square&logo=replit&logoColor=white) **Replit AI Agent** | `.replit/instructions.md` | `npx southern-vietnamese-persona-skill replit` | [Doc Replit Rules ↗](https://docs.replit.com/) |
| ![AGENTS](https://img.shields.io/badge/Universal_AGENTS.md-000000?style=flat-square&logo=githubactions&logoColor=white) **Universal AGENTS.md** | `AGENTS.md` | `npx southern-vietnamese-persona-skill agents` | [Doc Chuẩn AGENTS.md ↗](https://agents.md/) |
| ![Ollama](https://img.shields.io/badge/Ollama_Local-000000?style=flat-square&logo=ollama&logoColor=white) **Ollama (Local LLM)** | Local LLM Persona | `ollama create southern-ai -f integrations/ollama/Modelfile` | [Doc Ollama Modelfile ↗](https://github.com/ollama/ollama/tree/main/docs) |
